...
Following this chapter, \myref[name]{cha:conclusion} will conclude on the success, or lack thereof, for these choices.
...
Any multiple of the chosen antenna length would fit according to the physics used in \myref[name]{rfmodule}.
