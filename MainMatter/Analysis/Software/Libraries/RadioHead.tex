...
To use the \gls{rf}-modules with good results, some way of synchronising and encoding the transmissions can be used to reduce faults, like package loss.
...
First a preamble consisting of the binary pattern \enquote{1010} six times. 
...
Then a checksum is appended to the message to validate the integrity of the message, consisting of 24 bits after encoding.
...
To time this the built in timer; \enquote*{timer1}, on the Arduino is used, to trigger an interrupt with a high consistency.
