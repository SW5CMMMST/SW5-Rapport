...
Each byte (8-bits) is encoded as two 6-bit symbols, such that the 6-bit symbols will never contain more than three of the same signal in a row (high or low).\todo{burde vi overveje et eksempel på hvordan 8 bit bliver til 2x6? - M}
...
\end{table}
\todo{nogen grund til at caption er i toppen? ellers burde den nok stå under som på de andre tables. MP}
...
\todo{allerede beskrevet i TDMA. MP - Ved ikke om det decideret er beskrevet der, det er mere koncepterne, andre typer devices kan godt opdage et collision, men der menes her at man med radiohead ikke kan opdage at der er sket et collision. - SF}
% Af: Troels 
% D. 2015-09-17
%Review Søren 21. 09.
