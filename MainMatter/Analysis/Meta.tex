%\newpage
\bigskip
The following part of the paper will describe, analyse and evaluate the problem defined \myref{sec:problemStatement}, which concerns the difficulties of having multiple embedded systems communicate on the same radio frequency.
