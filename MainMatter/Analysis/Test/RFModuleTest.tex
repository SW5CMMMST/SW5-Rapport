...
This is done by simply having one Arduino with a transmitter, with an antenna length of 17.3 cm, transmitting the numbers from one to 100, and having three Arduinos with an antenna length of 17.3 cm receiving the data. 
