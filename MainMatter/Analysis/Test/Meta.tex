...
% \subsubsection*{Radio Frequency Module Difference Test (full test in \myref[name]{cha:radio_frequency_module_difference_test})}% (fold)
...
% 
% \subsubsection*{Radio Frequency Module Reception Test (full test in \myref[name]{cha:radio_frequency_module_reception_test})} % (fold)
...
% 
% \subsubsection*{RadioHead Time Sent Test (full test in \myref[name]{cha:radiohead_time_sent_test})} % (fold)
