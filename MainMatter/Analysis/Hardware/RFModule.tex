...
To achieve wireless communication between the devices a \gls{rf} module is used.
...
The benefit of using an antenna is an improvement in both greatest distance and accuracy of transmissions.
...
\noindent
Using the frequency, 433 MHz, the quarter- and half-monopole antenna lengths are 17.3 cm and 34.6 cm  \cite{AntennaLength}.
