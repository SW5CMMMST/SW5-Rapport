...
It has several pins, both for digital and anolog input/output.
Some of the pins have special abilities which allows to connect different modules, such as screens or Ethernet among others.
This properties of the pins will be further explored in \ref{subsubsec:arduino-uno-pins}.
