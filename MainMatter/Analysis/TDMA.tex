...
This method is a great starting point when designing the network of this report.
...
This is solved by having the transmitters taking turns transmitting their message in smaller time slots as seen on \myref{fig:tdmaoverview}.
...
\todo[inline]{What is the purpose of the code below? - Troels}
\code{Test}