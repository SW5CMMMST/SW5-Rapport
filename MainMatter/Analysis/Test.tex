...
The full tests is documented in \myref{cha:radio_frequency_module_difference_test}, \myref{cha:radio_frequency_module_reception_test} and \myref{cha:radiohead_time_sent_test}; this section will present the results of the tests, and explore its implication on the project.
