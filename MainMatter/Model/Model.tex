...
\begin{lstlisting}[language={[GUI]Uppaal}, % use GUI flavor
columns={[l]flexible},
frameround=fftt, frame=shadowbox, rulesepcolor=\color{gray}, title={This asks if a device \texttt{i}, and a device \texttt{j} are both transmitting, does it then mean they are the same.}]
