...
\begin{lstlisting}[style=UPPAAL, title={This query requires that eventually it all devices are connected, and no pair of devices have the same \texttt{k}.}]
...
This situation happens because it is chosen completely nondeterministically when they leave the initial location, however there is ofcourse a cap on how long that will be.

In order to fix this, very little has to change actually.
