...
Note that queries have been added to verify the model beyond the ones derived from the statements in \myref[name]{sec:Pseudo}, an example is query 2.
...
Handling the startup of multiple devices at the same time will be designed in \myref[name]{chap:MDA-CCRC}.
\newpage
