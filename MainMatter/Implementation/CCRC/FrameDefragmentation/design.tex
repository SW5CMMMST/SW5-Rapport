...
The Decremental Gradual Defragmentation-method will defragment the network, however it is slow, as it takes $(n - k + 1) * n_{max}$ frames to defragment, where $k$ is the time-slot which the device removed had. \todo{please doublecheck my math here.}
