...
\tikzfigure{DefragmentationFlowchart_1.tikz}{The needed changes to main loop.}{psuedo_1}
\tikzfigure{DefragmentationFlowchart_2.tikz}{The needed changes to main loop.}{psuedo_2}
\tikzfigure{DefragmentationFlowchart_3.tikz}{The needed changes to main loop.}{psuedo_3}
