...
This yields a weighted directed graph $G = (V, E, w)$, where $V$ is the set of devices as vertices $v$, $E \subseteq V \times V$ is the set of communication paths as edges $(v_i, v_j)$, and $w$ is the weight function representing the reliability of any communication path written as $w : e \rightarrow (0,1]$. 
