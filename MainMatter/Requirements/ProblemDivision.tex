...
\begin{description}[itemsep=2em]
    ...
    \begin{equation}
    \text{iff } \forall\, v_i, v_j \in V \, \exists (v_i,r,v_j)\in E\; |\; r = 1    
    \end{equation}
    ...
    \begin{equation}
    \text{iff } \forall\, v_i, v_j \in V \, \exists (v_i,r,v_j)\in E\; |\; 0 < r \leq 1
    \end{equation}
    ...
    \begin{equation}
    \begin{gathered}
    \text{iff } \forall\, v_i, v_j \in V \text{ there is a directed path from } v_i \text{ to } v_j\; \land \\ \forall\, e \in E\; |\; W(v_q, v_r) = 1
    \end{gathered}  
    \end{equation}   
    ...
    \begin{equation}
    \begin{gathered}
    \text{iff } \forall\, v_i, v_j \in V \text{ there is a directed path from } v_i \text{ to } v_j\; \land \\ \forall\, e \in E\; |\; 0 < W(v_q, v_r) \leq 1
    \end{gathered}  
    \end{equation}    
