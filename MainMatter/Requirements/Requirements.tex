...
In general there exists two kinds of software requirements, functional requirements and non-functional requirements. \todo{hvem har skrevet software requirements xD? vedkommende forstår ikke hvad non-functional er i såfald. Der skal stå system. - SF}
...
\begin{enumerate}[label=\itshape \alph*\upshape)]
    \item Being the first device in the network, this device should create the network so new devices can connect to the network in a time slot available to new devices. \todo{wat the fak, det giver hat mening :D - SF}
    ...
    \item The devices should be able to reliably communicate despite a packet loss up to 5\%. Pertains to non-functional requirement \textit{3} \todo{Måske vi så kun skulle simulere 0-5 \% senere så, eller lave det om her? - Troels}
