...
This worst case scenarico can be seen on \myref{fig:worsttimeccrc}. 
\tikzfigure{WorstCaseCCRCSingleConnect.tex}{Diagram showing worst case of a device connecting to a network}{worsttimeccrc} 
