...
If a network is found prior to \textit{x} exceeding $t_0$ the device will process the data and use this to properly obtain a slot in the network, this is done in the function \texttt{protocolMaintance} which was explained in \myref{subsec:protocolmaintanaince}.
