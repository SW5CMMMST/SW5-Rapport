...
During the lifetime of the devices, they should spend most of their time in this loop or in the user code\todo{User code is part of the loop? - Troels}. 
...
These processes is described in \myref[name]{sub:setupCCRC}.
