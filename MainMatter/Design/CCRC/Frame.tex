...
\tikzfigure{TimeSlotDesign.tikz}{A visual representation of the time slot, $\delta_{comm}$ and $\delta_{proc}$ denotes the time dedicated to each phase}{SlotDesign} 
