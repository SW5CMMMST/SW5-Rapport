...
A comparison has been made for this model with the previous model in \myref{sec:themodel}, when reverting back to allowing the devices to start at the same time.
