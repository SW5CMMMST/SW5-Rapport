...
The changes in the new model which handles that devices start at the same time also improves from the fact that they may start with bigger intervals, the results of running the query can be seen on \myref{CompareGraph}.
