...
On \myref{fig:pseudo_flowMultiConnect} it can be seen how method is merged into the existing flow chart (\myref{fig:psuedo_flowCCRC}) from \myref{sub:setupCCRC}.
