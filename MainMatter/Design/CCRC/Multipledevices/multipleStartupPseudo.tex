            ...
            \While {$x \le \delta$}
                ...
                \Else
                    \If {\Call{TimeToDie?}{$kill_{chance}$}} \Comment{$kill_{chance}\%$ of killing}
                        \State $a \gets a + 1$
                        \State \Call{RetryStartUp}{ } \Comment{Listen for networks then call \textsc{InitializeNetwork}}
                    \EndIf
                \EndIf
            \EndWhile
        \EndIf
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l|l|X|l}
        ...
        \midrule
        $c$                 & integer    & Number of attempts of creating a network, but capped at 5                         & $0 \leq a \leq 5$     \\
