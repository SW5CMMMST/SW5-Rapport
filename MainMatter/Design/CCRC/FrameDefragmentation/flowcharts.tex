...
There are added four changes to the main loop flowchart from \myref{fig:main_psuedo_flow}, note that the flowchart form CCRC is used again for simplicity sake, as can be seen in \myref{fig:mainFrameDefrag}.
