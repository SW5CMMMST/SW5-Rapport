...
In a simpler network where all devices serve the same purpose and the network is strongly\todo{complete? -morten} connected, one payload may suit the entire network where no variables are irrelevant.
...
\tikzfigure{ProtocolStruct.tikz}{TikZ it biatch}{payload_struct}  
\bigskip \noindent
\info[inline]{burde dette kode ikke være psuedo? - morten}
