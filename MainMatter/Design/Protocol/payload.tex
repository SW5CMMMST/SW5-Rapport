...
Additionally the transmission time increases as the size of the payload increases, this further can increase the risk of packet loss. 
...
A 1 byte address would allow 256 addresses, however a few may be reserved for uses such as broadcast.
This payload is reasonably small, the size of the data field will depend on the user code on the device.
