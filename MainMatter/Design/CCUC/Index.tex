...
In order to adapt the CCRC-solution to work for the CCUC-problem the changes required must consider no just the chance for packet loss to occur, but also the effect.
