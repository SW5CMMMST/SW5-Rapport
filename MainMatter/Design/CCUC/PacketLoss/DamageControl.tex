...
As a transmission is not received the procedure \texttt{protocolMaintaince}, \myref{lst:maintaniance}, is not run and as such it is possible that the device may be slightly out of sync.
