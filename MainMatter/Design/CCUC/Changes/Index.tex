...
As a consequence of that decision the idea of message redundancy as presented in \myref[name]{sub:avoidance} will be subject to  validation during the CCUC-problem.
