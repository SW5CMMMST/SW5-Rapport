...
This section will explore to what degree issues caused by unreliability affects the UPPAAL model previously developed.
...
The results shows that transmitting more than once is actually a viable option, as it increases the probability of a network containing all devices will be made.
\todo[inline]{Er lidt i tvivl om jeg forstår den sidste del herfra og ned korrekt. - Troels}
