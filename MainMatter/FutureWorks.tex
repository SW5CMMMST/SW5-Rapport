...
A possible improvement to the protocol which assume a strongly connected network in which at least two devices cannot receive messages from each other nor their respective neighbours, is the following.
