\chapter{Radio Frequency Module Difference Test} % (fold)
...
The software on the Arduinos is the same as in the test in \myref{cha:radio_frequency_module_reception_test}, i.e. a transmitting part which sends 100 unique packages and a receiving part which registers any package loss. 
